...
git clone --depth=1 https://github.com/orrb7/android_device_advan_X1-kernel.git -b master device/advan/X1-kernel

git clone https://github.com/DooPrjkt/kernelDummy.git -b main kernel/advan/X1
